...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header Header ColorHeader">{{ 'ثبت نام' }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-start">{{ 'نام و نام خانوادگی' }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4 pe-5">
                                <button type="submit" class="btn ColorHeader Header me-5 pe-5 ps-5">
                                    {{ 'ثبت نام' }}
                                </button>
                            </div>
                        </div>
